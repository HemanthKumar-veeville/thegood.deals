...
const CurrencySelection = () => {
  ...
  const confirmCurrency = () => {
    dispatch(
      updateCurrencySetting(selectedCurrency === "Euro" ? "EUR" : "USD")
    );
  };
      ...
      {status !== "loading" && (
        <div className="inline-flex flex-col items-start gap-[15px] px-[35px] py-[15px] relative flex-[0_0_auto] w-full">
          ...
          <div className="flex flex-col h-12 items-start gap-[5px] relative self-stretch w-full">
            ...
            {showDropdown && (
              <div className="absolute top-10 left-0 w-full bg-white border border-solid border-stroke rounded-md z-10">
