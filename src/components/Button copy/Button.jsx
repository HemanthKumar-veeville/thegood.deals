...
export const Button = ({ buttonText = "Button", kind, color, state, round, className, buttonTextClassName }) => {
  return (
    <button
      className={`all-[unset] box-border inline-flex items-center gap-2.5 px-7 py-[13px] justify-center relative ${
        ...
        round === "semi-round" ? "rounded-md" : round === "full-rounded" ? "rounded-[50px]" : ""
      } ${
...
Button.propTypes = {
  ...
  round: PropTypes.oneOf(["squire", "full-rounded", "semi-round"]),
};
