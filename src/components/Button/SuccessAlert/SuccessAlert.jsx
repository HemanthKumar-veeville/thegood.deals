...
export const SuccessAlert = ({
  ...
  frameClassName,
  groupClassName,
  icon = <CheckmarkCircle2 className="!absolute !w-3 !h-3 !top-1 !left-1" color="white" />,
  divClassName,
    ...
    >
          ...
          >
            {style === "one" && (
              <div className="relative h-[34px] rounded-md">
                ...
                <CheckmarkCircle2 className="!absolute !w-[18px] !h-[18px] !top-2 !left-2" color="#22AD5C" />
              </div>
            )}

            {style === "two" && (
              <CheckmarkCircle3 className="!absolute !w-[18px] !h-[18px] !top-2 !left-2" color="white" />
            )}
          </div>
          <div
      ...
      {style === "three" && (
        <div className={`inline-flex items-center gap-3 relative flex-[0_0_auto] ${frameClassName}`}>
          <div className={`relative w-5 h-5 bg-greengreen rounded-[10px] ${groupClassName}`}>{icon}</div>
          <p
