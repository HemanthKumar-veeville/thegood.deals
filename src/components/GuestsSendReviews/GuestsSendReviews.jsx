...
export const GuestsSendReviews = ({
  ...
  const handleSubmit = () => {
    alert(`
      ${t("guestsSendReviews.organizerRating")}: ${organizerRating}/5
      ${t("guestsSendReviews.organizerRemarks")}: ${organizerRemarks}
      ${t("guestsSendReviews.productRating")}: ${productRating}/5
      ${t("guestsSendReviews.productRemarks")}: ${productRemarks}
      ${t("guestsSendReviews.platformRating")}: ${platformRating}/5
      ${t("guestsSendReviews.platformRemarks")}: ${platformRemarks}
    `);
  };
